...
class KarProfileController extends Controller
{
    public function index()
    {
        ...
        return view('karyawan.profile.users', compact('user', 'karyawan'));
    }
    ...
    public function detail(){
        ...
        return view('karyawan.profile.detail', compact('user', 'karyawan', 'divisis', 'pendidikans'));
    }
    ...
    public function edit(Karyawan $karyawan){
        ...
        return view('karyawan.profile.detail', compact(
            'user',
            'karyawan',
            'divisis',
            'pendidikans'
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('karyawan.profile.detail')
