<x-admin-layout>
    ...
    <div class="relative flex-grow pb-10">
        ...
        <main class="p-4 -mt-12 relative z-20 space-y-5">
            <form action="{{ route('admin.profile.update', $karyawan->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $karyawan->tempat_lahir ?? 'Tempat Lahir'}}" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-default" readonly>
                    </div>
                    <!-- Tanggal Lahir -->
                    <div class="relative">
                         <label class="block mb-0.5 text-xs font-medium text-gray-500">Tanggal Lahir</label>
                         <input type="text" value="{{ $karyawan->tanggal_lahir }}" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 cursor-default" readonly>
