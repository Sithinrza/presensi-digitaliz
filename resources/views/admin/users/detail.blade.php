            ...
            <div class="bg-white p-6 rounded-2xl shadow-lg">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="987654321" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-default" readonly>
                    </div>
                    <!-- Tempat Lahir -->
                    <div>
                    ...
                    <div>
                        ...
                        <textarea rows="3" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-100 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 cursor-default" readonly>Jln. Adhyaksa Raya .....</textarea>
                    </div>
                    <!-- Pendidikan Terakhir -->
                    <div>
                    ...
                    <!-- Status -->
                    <div>
                        <label class="block mb-0.5 text-xs font-medium text-gray-500">Status</label>
                         <div class="relative">
                            <select class="appearance-none bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-default" disabled>
                    ...
                    <div>
                        ...
                        <input type="tel" value="085274196387" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-default" readonly>
                    </div>
                </div>
            </div>
