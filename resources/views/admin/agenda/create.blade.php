<x-admin-layout>
    ...
    {{-- 2. CUSTOM CSS UNTUK TAMPILAN MULTI-SELECT BARU --}}
    <style>
        /* Styling kustom untuk komponen Custom Multi-Select */
        ...
        /* Styling untuk memastikan chip terlihat */
        ...
        <form id="formTambahAgenda" action="{{ route('admin.agenda.store') }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-lg ">
                ...
                <div class="space-y-6">
                    ...
                    @php
                        // Default untuk halaman Buat/Tambah adalah array kosong
                        $selectedDivisi = old('peserta_divisi') ? (array)old('peserta_divisi') : [];
                    ...
                    <div>
                        ...
                        <div class="relative custom-select-wrapper">
                            <button type="button" class="flex flex-wrap items-center justify-between w-full px-4 py-2 text-left bg-white border border-gray-300 rounded-lg shadow-sm cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" id="dropdownDivisiTrigger">
                                <span class="text-gray-900 trigger-summary flex-grow" data-placeholder="Cari dan pilih Divisi..."></span>
