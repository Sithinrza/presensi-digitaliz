                ...
                <form action="{{ route('admin.report.index') }}" method="GET" id="filter-form" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="filter_tanggal" name="tanggal" class="bg-gray-50 border border-gray-200 text-gray-800 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full ps-10 p-2.5 transition-shadow duration-200 focus:shadow-md" placeholder="Pilih Tanggal" value="{{ $selected_date }}">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="search_karyawan" name="search" class="bg-gray-50 border border-gray-200 text-gray-800 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full ps-10 p-2.5 transition-shadow duration-200 focus:shadow-md" placeholder="Nama karyawan..." value="{{ $search_query ?? '' }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end gap-2 pt-2">
                        @if (($selected_date && $selected_date !== 'all') || $search_query)
                            <a href="{{ route('admin.report.index', ['tanggal' => 'all']) }}" class="inline-flex items-center justify-center gap-2 bg-gray-100 text-gray-600 text-sm font-semibold py-2 px-4 rounded-lg hover:bg-gray-200 transition-all">
                        ...
                        <div class="p-5 pl-6">
                            ...
                            <div class="border-t border-gray-50 pt-3 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @if ($linkAttachment)
                                        <a href="{{ $linkAttachment->url_or_path }}" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-600 text-xs font-medium rounded-lg hover:bg-blue-100 transition border border-blue-100">
                                            <i class="fa-brands fa-figma"></i> Link
                                        </a>
                                    @endif
                                    @if ($fileAttachment)
                                        <a href="{{ Storage::url($fileAttachment->url_or_path) }}" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 text-green-600 text-xs font-medium rounded-lg hover:bg-green-100 transition border border-green-100">
                                ...
                                <button type="button"
                                    ...
                                    data-modal-target="verifikasi-modal" data-modal-toggle="verifikasi-modal" class="open-verify-modal inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-xs font-bold rounded-lg hover:bg-indigo-700 transition shadow-md active:scale-95">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <label class="cursor-pointer">
                                ...
                                <div class="p-2 rounded-lg border border-gray-200 text-center peer-checked:border-green-500 peer-checked:bg-green-50 hover:bg-gray-50 transition">
                                    ...
                                    <span class="text-xs font-bold text-gray-600 peer-checked:text-green-700">Approve</span>
                                </div>
                            </label>
                            <label class="cursor-pointer">
                            ...
                            <label class="cursor-pointer">
                                ...
                                <div class="p-2 rounded-lg border border-gray-200 text-center peer-checked:border-red-500 peer-checked:bg-red-50 hover:bg-gray-50 transition">
                                    ...
                                    <span class="text-xs font-bold text-gray-600 peer-checked:text-red-700">Rejected</span>
                                </div>
                            </label>
                        </div>
                    </div>
