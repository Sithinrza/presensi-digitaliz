    ...
    <div class="w-full max-w-screen-lg mx-auto bg-indigo-950 rounded-full shadow-lg">
        <div class="flex items-center justify-around p-2">
            ...
            <a href="{{ route('karyawan.dashboard') }}" 
               class="p-2 rounded-full {{ Route::is('karyawan.dashboard') ? 'bg-white text-indigo-950' : 'text-white' }} transition-colors duration-200">
            ...
            <a href="{{ route('karyawan.agenda.index') }}"
               class="p-2 rounded-full {{ Route::is('karyawan.agenda.*') ? 'bg-white text-indigo-950' : 'text-white' }} transition-colors duration-200">
            ...
            <a href="{{ route('karyawan.presensi.index') }}"
               class="p-2 rounded-full {{ Route::is('karyawan.presensi.*') ? 'bg-white text-indigo-950' : 'text-white' }} transition-colors duration-200">
                <svg class="w-7 h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            {{-- Tombol Log Aktivitas/Report --}}
            <a href="{{ route('karyawan.log.index') }}"
               class="p-2 rounded-full {{ Route::is('karyawan.log.*') ? 'bg-white text-indigo-950' : 'text-white' }} transition-colors duration-200">
                <svg class="w-7 h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            {{-- Tombol Profil --}}
            <a href="{{ route('karyawan.profile.index') }}"
               class="p-2 rounded-full {{ Route::is('karyawan.profile.*') ? 'bg-white text-indigo-950' : 'text-white' }} transition-colors duration-200">
                <svg class="w-7 h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
