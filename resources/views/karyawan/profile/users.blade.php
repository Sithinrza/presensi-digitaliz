    ...
    <div class="relative min-h-screen flex flex-col bg-gray-50">
        ...
        <main class="flex-grow p-4 -mt-8 relative z-20 space-y-6">
            ...
            <div class="bg-white p-5 rounded-2xl shadow-lg border border-gray-100">
                ...
                <a href="{{ route('karyawan.profile.detail') }}" class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-indigo-50 hover:text-indigo-700 transition group border border-transparent hover:border-indigo-100">
